...
HELP_START_DATE = "Start date, inclusive (YYYY-MM-DD). Use day 01 for a full month."
HELP_END_DATE = "End date, exclusive (YYYY-MM-DD). Use day 01 for a full month boundary."
